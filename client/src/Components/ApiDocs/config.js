const globalTableData = {
    type: {
        param: 'type',
        permission: 'Optional',
        description: 'Specifies a file type for the returned data. Options: json or csv (e.g., type=csv). Default: json.'
    },
    sort: {
        param: 'sort',
        permission: 'Optional',
        description: 'Specifies if response is sorted by date. Options: asc (ascending) or desc (descending). Example: sort=asc. Default: unsorted.'
    }
};
...
const config = {
    ...
    endpointData: [
        ...
        },
        {
            ...
            apiCall: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/tractdaily',
            tableData: [
                {
                    param: 'FilingDate',
                    permission: 'Optional',
                    description: 'A specific date, multiple dates or range of dates in the MM/DD/YYYY format (e.g., FilingDate=01/01/2022, FilingDate=01/01/2022&FilingDate=02/01/2022 or FilingDate=01/01/2022-01/31/2022).'
                },
                {
                    param: 'Year',
                    permission: 'Optional',
                    description: 'A specific year in the YYYY format (e.g., Year=2022). Cannot be combined with a FilingDate parameter or be a range of years.'
                },
                {
                    param: 'TractID',
                    permission: 'Optional',
                ...
                },
                {
                    param: 'CountyID',
                    permission: 'Optional',
                    description: 'The last three digits of a county FIPS code (e.g., CountyID=121 will query Fulton County).'
                },
                globalTableData.sort,
                globalTableData.type
            ],
            sampleRequest: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/tractdaily?Year=2021&sort=asc'
        },
        {
            title: 'Monthly Filings By Census Tract',
            endpoint: '/tractbymonth',
            description: 'GET monthly eviction data by census tract.',
            apiCall: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/tractbymonth',
            tableData: [
                {
                    param: 'TractID',
                    permission: 'Optional',
            ...
            sampleRequest: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/tractbymonth?CountyID=089&type=csv'
        },
        {
            title: 'Weekly Filings By County',
            endpoint: '/countyweekly',
            description: 'GET weekly eviction data by county.',
            apiCall: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/countyweekly',
            tableData: [
                {
                    param: 'FilingWeek',
                    permission: 'Optional',
                    description: 'A date that represents the start of a specific week in the MM/DD/YYYY format. Can also be multiple dates or a range of dates (e.g.: FilingWeek=01/02/2022, FilingWeek=01/02/2022&FilingWeek=01/09/2022 or FilingWeek=01/02/2022-01/16/2022).'
                },
                {
                    param: 'Year',
                    permission: 'Optional',
                    description: 'A specific year in the YYYY format (e.g., Year=2021). Cannot be combined with a FilingWeek query or be a range of years.'
                },
                {
                    param: 'CountyID',
                    permission: 'Optional',
            ...
            sampleRequest: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/countyweekly?CountyID=135&FilingWeek=01/02/2022-01/30/2022&sort=asc'
        },
        {
            title: 'Monthly Filings By County',
            endpoint: '/countymonthly',
            description: 'GET monthly eviction data by county.',
            apiCall: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/countymonthly',
            tableData: [
                {
                    param: 'FilingMonth',
                    permission: 'Optional',
                    description: 'A date that represents the start of a specific month in the MM/DD/YYYY format (e.g., querying January 2022 would be FilingMonth=01/01/2022). Can also be multiple dates or a range of dates (e.g., FilingMonth=01/01/2022&FilingMonth=02/01/2022 OR FilingMonth=01/01/2022-06/01/2022).'
                },
                {
                    param: 'Year',
                    permission: 'Optional',
                    description: 'A specific year in the YYYY format (e.g., Year=2022). Cannot be combined with a FilingMonth query or be a range of years.'
                },
                {
                    param: 'CountyID',
                    permission: 'Optional',
            ...
            sampleRequest: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/countymonthly?Year=2021&sort=desc&type=csv'
        },
        {
            title: 'Filings By Building',
            endpoint: '/buildings',
            description: 'GET eviction data by building.',
            apiCall: 'https://metroatlhousing.org/atlanta-region-eviction-tracker/rest/buildings',
            tableData: [
                {
                    param: 'city, zip',
                    permission: 'Optional',
                ...
                },
                {
                    param: 'county',
                    permission: 'Optional',
                    description: 'The last three digits of a county FIPS code (e.g., county=135 will query Gwinnett County).'
                },
                {
                    param: 'latitude, longitude',
                    permission: 'Optional',
                    description: 'An exact latitude and/or longitude of a building (e.g., latitude={some value}&longitude={some value}).'
                },
                {
                    param: 'tractid',
                    permission: 'Optional',
                ...
                },
                {
                    param: 'street',
                    permission: 'Optional',
                    description: 'A street address for the building (e.g., street=123%somewhere%dr).'
                },
                globalTableData.type
            ],
