...
export const Sources = content => (
  <div className='about-content-section'>
    ...
    <ul id='about-content-source-list'>
      {content
        ?.sources
        ?.filter(source => source?.type === content?.type)
        ?.map((source, i) => (
          <li
            key={`source-${i}`}
...
export const DataRequest = () => (
  <div className='about-content-section'>
    ...
    <p>
      If you or your organization would like access to data at a level of
      aggregation or format not available via the `&quot`Download
      Data`&quot` button on the tool, you will need to submit a formal
      request. Click the button below to begin the request process.
    </p>
    <p>
      <a
...
export const Citations = content => (
  <div className='about-content-section'>
