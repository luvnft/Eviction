...
const getBuildingInfo = async () => {
  const filings = require('./caseInfo/metrocase.json');
  const buildingInfo = {};
  ...
  Object.entries(buildingInfo).forEach(([key,value]) => {
    ...
    buildingInfo[key]['monthlyfilings'] = aggregateBy(value.filings, 'filingdate', 'countByMonth')
  })
